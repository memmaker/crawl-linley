...
void zapping(char ztype, int power, struct bolt &pbolt)
{
    ...
    {
#ifdef JP
        mpr("Ç†Ç»ÇΩÇÕóãñ¬Ç™óÕã≠Ç≠çåÇ≠ÇÃÇé®Ç…ÇµÇΩÅI");
#else
...
static void zappy( char z_type, int power, struct bolt &pbolt )
{
...
#ifdef JP
        strcpy(pbolt.beam_name, "óÕèÍÇÃñÓ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ñÇñ@ÇÃñÓ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, (temp_rand == 0) ? "çªö∫" :
                                (temp_rand == 1) ? "ìyâå" :
                                (temp_rand == 2) ? "çªêo" : "çª");
        strcat(pbolt.beam_name, "ÇÃìÀïó");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, coinflip() ? "îÚ‚IÇÃâJ" : "îÚ‚IÇÃâJ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "çúï–ÇÃéUíe");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ó‚ãCÇÃâÚ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "êŒêçÇÃñÓ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "èƒàŒÇÃâä");        // extra damage
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ÉGÉlÉãÉMÅ[ÇÃîöóÙãÖ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ónä‚ÇÃñÓ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ñ“âŒÇÃñÓ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ìÄåãÇÃñÓ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ì≈âtÇÃñÓ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ïâÇÃÉGÉlÉãÉMÅ[ÇÃñÓ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ìSâÚÇÃñÓ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ì≈ëfÇÃñÓ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "àÓç»ÇÃñÓ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ÉtÉ@ÉCÉAÉ{Å[Éã");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ìdåÇÇÃîöóÙãÖ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ã‡ëÆï–ÇÃîöóÙãÖ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "â©ã‡ÇÃâä");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "êÖèªÇÃëÑ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ínçñÇÃã∆âŒ");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ìÄãCÇÃóí");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ÉGÉlÉãÉMÅ[ÇÃåıê¸");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ì≈ÇÃîÚñó");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "âäÇÃÉuÉåÉX");
#else
    ...
    case ZAP_BREATHE_FROST:     // cap 50
        // max power = lev = 27
#ifdef JP
        strcpy(pbolt.beam_name, "ìÄåãÇÃÉuÉåÉX");
#else
    ...
    case ZAP_BREATHE_POISON:    // leaves clouds of gas // cap 50
        // max power = lev = 27
#ifdef JP
        strcpy(pbolt.beam_name, "ñ“ì≈ÇÃÉKÉX");
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "ÉGÉlÉãÉMÅ[ÇÃñÓ");
#else
    ...
    case ZAP_BREATHE_STEAM:     // cap 50
        // max power = lev = 27
#ifdef JP
        strcpy(pbolt.beam_name, "èˆãCÇÃîöóÙãÖ");
#else
...
#ifdef JP
        strcpy( pbolt.beam_name, "îpä¸ÇÃåı" );
#else
    ...
    default:
#ifdef JP
        strcpy(pbolt.beam_name, "ÉoÉOÇ»åıê¸");
#else
                           ...
                           int hurted, bool doFlavouredEffects )
{
    ...
    case BEAM_FIRE:
...
#ifdef JP
                simple_monster_message(monster, "Ç…ÇÕå¯Ç¢ÇƒÇ¢Ç»Ç¢ÇÊÇ§ÇæÅB");
#else
        ...
        else if (resist == 1)
        {
            if (doFlavouredEffects)
#ifdef JP
                simple_monster_message(monster, "ÇÕéÙï∂Ç…íÔçRÇµÇΩÅB");
#else
        ...
        else if (resist < 0)
        {
                ...
                || monster->type == MONS_SIMULACRUM_LARGE)
            {
                if (doFlavouredEffects)
#ifdef JP
                    simple_monster_message(monster, "ÇÕónÇØÇæÇµÇΩÅI");
#else
            ...
            else
            {
                if (doFlavouredEffects)
#ifdef JP
                    simple_monster_message(monster, "ÇÕåÉÇµÇ≠îRÇ¶Ç†Ç™Ç¡ÇΩÅI");
#else
    ...
    case BEAM_COLD:
        ...
        else if (resist < 0)
        {
            if (doFlavouredEffects)
#ifdef JP
                simple_monster_message(monster, "ÇÕìÄÇËÇ¬Ç¢ÇΩÅI");
#else
    ...
    case BEAM_POISON_ARROW:
        if (mons_res_poison(monster) > 0)
        {
            ...
            {
#ifdef JP
                simple_monster_message( monster, "ÇÕäÙÇÁÇ©ëœê´Çé¶ÇµÇΩÅB" );
#else
...
#ifdef JP
            simple_monster_message(monster, "ÇÕêäé„ÇµÇΩÅB");
#else
...
#ifdef JP
    else if (stricmp(pbolt.beam_name, "ínçñÇÃã∆âŒ") == 0)
#else
...
bool mass_enchantment( int wh_enchant, int pow, int origin )
{
    ...
    for (i = 0; i < MAX_MONSTERS; i++)
    {
        ...
        {
#ifdef JP
            simple_monster_message(monster, "ÇÕâeãøÇéÛÇØÇƒÇ¢Ç»Ç¢ÅB");
#else
...
int mons_ench_f2(struct monsters *monster, struct bolt &pbolt)
{
    ...
    case BEAM_SLOW:         /* 0 = slow monster */
        ...
        {
#ifdef JP
            if (simple_monster_message(monster, "ÇÕÇ‡ÇÕÇ‚çÇë¨Ç…ìÆÇ¢ÇƒÇÕÇ¢Ç»Ç¢ÅB"))
#else
        ...
        if (mons_add_ench(monster, ENCH_SLOW))
        {
            ...
            // notice slow down.
#ifdef JP
            if (simple_monster_message(monster, "ÇÃìÆÇ´Ç™ì›èdÇ…Ç»Ç¡ÇΩÇÊÇ§ÇæÅB"))
#else
    ...
    case BEAM_HASTE:                  // 1 = haste
        ...
        {
#ifdef JP
            if (simple_monster_message(monster, "Ç©ÇÁì›èdÇ≥Ç™é∏ÇπÇΩÅB"))
#else
        ...
        if (mons_add_ench(monster, ENCH_HASTE))
        {
            ...
            // notice speed up.
#ifdef JP
            if (simple_monster_message(monster, "ÇÃìÆçÏÇ™çÇë¨Ç…Ç»Ç¡ÇΩÇÊÇ§ÇæÅB"))
#else
    ...
    case BEAM_HEALING:         /* 2 = healing */
        if (heal_monster( monster, 5 + roll_dice( pbolt.damage ), false ))
        {
            ...
            {
#ifdef JP
                if (simple_monster_message(monster, "ÇÃïâèùÇÕäÙÇÁÇ©ñ¸Ç≥ÇÍÇΩÅB"))
#else
...
#ifdef JP
        if (simple_monster_message(monster, "Ç™ìÀëRìÆÇ©Ç»Ç≠Ç»Ç¡ÇΩÅI"))
#else
...
#ifdef JP
            if (simple_monster_message(monster, "ÇÕç¨óêÇµÇΩÇÊÇ§ÇæÅB"))
#else
    ...
    case BEAM_INVISIBILITY:               /* 5 = invisibility */
        ...
        if (mons_add_ench(monster, ENCH_INVIS))
        {
            ...
            {
#ifdef JP
                snprintf( info, INFO_SIZE, "%sÇÕ%s",
                          buff, player_see_invis() ? "àÍèuÇæÇØñæñ≈ÇµÇΩÅB"
                                                   : "ñæñ≈ÇµÇƒÅAépÇè¡ÇµÇΩÅI" );
#else
...
#ifdef JP
            if (simple_monster_message(monster, "ÇÕñ£óπÇ≥ÇÍÇΩÅB"))
#else
...
#ifdef JP
        simple_monster_message( monster,
                                (old_strength == 0) ? "ÇÕì≈Ç…ñ`Ç≥ÇÍÇΩÇÊÇ§ÇæÅB"
                                                    : "ÇÕçXÇ…èdÇ≠ì≈Ç…ñ`Ç≥ÇÍÇΩÇÊÇ§ÇæÅB" );
#else
        simple_monster_message( monster,
...
#ifdef JP
        simple_monster_message(monster, "ÇÕîRÇ¶ÇΩÇ¨ÇÈâtëÃÇóÅÇ—ÇΩÅI");
#else
...
#ifdef JP
    if (strcmp(beam.beam_name, "ì≈ëfÇÃï˙éÀ") == 0)
#else
...
#ifdef JP
    if (strcmp(beam.beam_name, "‚qÇÍÇΩèˆãC") == 0)
#else
...
#ifdef JP
    if (strcmp(beam.beam_name, "ìdåÇÇÃîöóÙãÖ") == 0
        || strcmp(beam.beam_name, "ã‡ëÆï–ÇÃîöóÙãÖ") == 0
        || strcmp(beam.beam_name, "ìÄãCÇÃóí") == 0)
#else
...
#ifdef JP
    if (strcmp(beam.beam_name, "·èãCÇÃîöóÙãÖ") == 0)
#else
    ...
    if (beam.flavour == BEAM_DIGGING)
    {
        ...
        if (grd[x][y] == DNGN_ROCK_WALL)
        {
            ...
            if (!beam.msgGenerated)
            {
                ...
                {
#ifdef JP
                    mpr("Ç†Ç»ÇΩÇÕä‚ÇçÌÇÈëõâπÇé®Ç…ÇµÇΩÅB");
#else
    ...
    if (beam.flavour == BEAM_DISINTEGRATION || beam.flavour == BEAM_NUKE)
    {
                ...
                && targ_grid <= DNGN_STATUE_39))
        {
            ...
            if (!silenced(you.x_pos, you.y_pos))
            {
                if (!see_grid( x, y ))
#ifdef JP
                    mpr("Ç†Ç»ÇΩÇÕé®è·ÇËÇ»ã‡êÿÇËê∫Çé®Ç…ÇµÇΩÅI");
#else
                    mpr("You hear a hideous screaming!");
#endif
                else
#ifdef JP
                    mpr("ëúÇÕã‡êÿÇËê∫ÇÇ†Ç∞Ç»Ç™ÇÁïˆâÛÇµÇΩÅI");
#else
            ...
            else
            {
                if (see_grid(x,y))
#ifdef JP
                    mpr("ëúÇÕîPÇÍÅAêUìÆÇµÅAÇªÇµÇƒïˆâÛÇµÇΩÅI");
#else
...
static int affect_place_clouds(struct bolt &beam, int x, int y)
{
    ...
    if (env.cgrid[x][y] != EMPTY_CLOUD)     // hit a cloud
    {
            ...
            && beam.flavour == BEAM_COLD))
        {
            ...
            {
#ifdef JP
                mpr("Ç†Ç»ÇΩÇÕÉWÉÖÅ[ÉWÉÖÅ[Ç∆Ç¢Ç§âπÇé®Ç…ÇµÇΩÅB");
#else
    ...
    // ORB OF ENERGY
#ifdef JP
    if (strcmp(beam.beam_name, "ÉGÉlÉãÉMÅ[ÇÃîöóÙãÖ") == 0)
#else
    ...
    // GREAT BLAST OF COLD
#ifdef JP
    if (strcmp(beam.beam_name, "ìÄãCÇÃóí") == 0)
#else
    ...
    // BALL OF STEAM
#ifdef JP
    if (strcmp(beam.beam_name, "èˆãCÇÃîöóÙãÖ") == 0)
#else
    ...
    // STICKY FLAME
#ifdef JP
    if (strcmp(beam.beam_name, "èƒàŒÇÃâä") == 0)
#else
    ...
    // POISON GAS
#ifdef JP
    if (strcmp(beam.beam_name, "ñ“ì≈ÇÃÉKÉX") == 0)
#else
...
#ifdef JP
    if (stricmp(beam.beam_name, "ïXÇÃóí") == 0)
#else
...
#ifdef JP
    if (stricmp(beam.beam_name, "à´èLÇÃâ_") == 0)
#else
...
#ifdef JP
    if (strcmp(beam.beam_name, "âŒâãÇÃóí") == 0)
#else
...
static void affect_items(struct bolt &beam, int x, int y)
{
...
#ifdef JP
    if (stricmp(beam.beam_name, "ínçñÇÃã∆âŒ") == 0)
#else
    ...
    if (igrd[x][y] != NON_ITEM)
    {
            ...
            mitm[igrd[x][y]].base_type == objs_vulnerable)
        {
            ...
            {
#ifdef JP
                mpr("Ç†Ç»ÇΩÇÕâåÇ™è„Ç™ÇÈÇÃÇñ⁄Ç…ÇµÇΩÅB");
#else
            ...
            {
#ifdef JP
                mpr("Ç†Ç»ÇΩÇÕÉKÉâÉXÇÃäÑÇÍÇÈâπÇé®Ç…ÇµÇΩÅB");
#else
...
static int affect_player( struct bolt &beam )
{
        ...
        if (!beam.isExplosion && !beam.aimedAtFeet)
        {
            ...
            if (beam.isBeam)
            {
                ...
                if (beamHit < dodge)
                {
                    ...
                    strcat(info, "ÇÕÇ†Ç»ÇΩÇ…ìñÇΩÇÁÇ»Ç©Ç¡ÇΩÅB");
#else
                    strcpy(info, "The ");
                    strcat(info, beam.beam_name);
            ...
            else
            {
                        ...
                        && player_shield_class() > 0)
                {
                    ...
                    if (hit < block)
                    {
                        you.shield_blocks++;
#ifdef JP
                        snprintf( info, INFO_SIZE, "Ç†Ç»ÇΩÇÕ%sÇñhå‰ÇµÇΩÅB",
#else
    ...
    else
    {
        ...
        case BEAM_POLYMORPH:
#ifdef JP
            mpr("Ç±ÇÃéÙï∂ÇÕëºé“Ç…ÇÃÇ›çÏópÇ∑ÇÈÅI");
#else
        ...
        case BEAM_BANISH:
            ...
            {
#ifdef JP
                mpr("Ç†Ç»ÇΩÇÕ„©Ç…ïﬂÇ¶ÇÁÇÍÇΩÇÊÇ§ÇæÅB");
#else
...
#ifdef JP
            mpr("Ç†Ç»ÇΩÇÕÉAÉrÉXÇ…ìÀÇ´óéÇ∆Ç≥ÇÍÇΩÅI");
#else
        ...
        case BEAM_PAIN:      // pain
...
#ifdef JP
            mpr("ãÍí…Ç™Ç†Ç»ÇΩÇÃëSêgÇä—Ç¢ÇΩÅI");
#else
            ...
            if (!beam.aux_source)
#ifdef JP
                beam.aux_source = "ê_åoÇñ`Ç∑ãÍí…Ç…ÇÊÇ¡Çƒ";
#else
        ...
        case BEAM_DISPEL_UNDEAD:
            ...
            if (!beam.aux_source)
#ifdef JP
                beam.aux_source = "ÉfÉBÉXÉyÉãÇ…ÇÊÇ¡Çƒ";
#else
...
#ifdef JP
            mpr("É\ÉtÉgÉEÉFÉAÉoÉOÇ™Ç†Ç»ÇΩÇÃí‹êÊÇÍñÇ¡ÇΩÅI");
#else
...
#ifdef JP
    snprintf( info, INFO_SIZE, "%sÇ™Ç†Ç»ÇΩ%sÅI",
                beam.beam_name, (beam.isExplosion ? "Çä™Ç´çûÇÒÇæ" : "Ç…ñΩíÜÇµÇΩ") );
#else
    ...
    // poisoning
#ifdef JP
    if (strstr(beam.beam_name, "ì≈") != NULL
       && (strstr(beam.beam_name, "ì≈êj") == NULL)
#else
    ...
    {
#ifdef JP
        if (hurted || (strstr( beam.beam_name, "êÅÇ´ñÓêj" ) != NULL
#else
...
#ifdef JP
    if (beam.flavour == BEAM_LAVA || stricmp(beam.beam_name, "ínçñÇÃã∆âŒ") == 0)
#else
    ...
    // more complex (geez..)
#ifdef JP
    if (beam.flavour == BEAM_FIRE && strcmp(beam.beam_name, "èˆãCÇÃîöóÙãÖ") != 0)
#else
...
static int  affect_monster(struct bolt &beam, struct monsters *mon)
{
    ...
    if (beam.beam_name[0] == '0')
    {
        ...
        switch(ench_result)
        {
            case MON_RESIST:
#ifdef JP
                if (simple_monster_message(mon, "ÇÕéÙï∂Ç…íÔçRÇµÇΩÅB"))
#else
            ...
            case MON_UNAFFECTED:
#ifdef JP
                if (simple_monster_message(mon, "ÇÕâeãøÇéÛÇØÇƒÇ¢Ç»Ç¢ÅB"))
#else
    ...
    if (mons_near(mon))
    {
        ...
        if (player_monster_visible( &menv[tid] ))
            ...
            strcat(info, "âΩé“Ç©");
        strcat(info, beam.isExplosion?"Çä™Ç´çûÇÒÇæ":"Ç…ñΩíÜÇµÇΩ");
#else
        strcpy(info, "The ");
        strcat(info, beam.beam_name);
    ...
    else
    {
                ...
                && YOU_KILL(beam.thrower))
        {
            ...
            strcpy(info, "");
            strcat(info, beam.beam_name);
            strcat(info, "ÇÕâΩé“Ç©Ç…ñΩíÜÇµÇΩÅB");
#else
            strcpy(info, "The ");
            strcat(info, beam.beam_name);
    ...
    else
    {
        ...
        {
#ifdef JP
            if (strstr(beam.beam_name, "êÅÇ´ñÓêj") != NULL
#else
...
static int affect_monster_enchantment(struct bolt &beam, struct monsters *mon)
{
...
#ifdef JP
        if (simple_monster_message(mon, "ÇÕè≠ÇµïsämíËÇ…Ç»Ç¡ÇΩÇÊÇ§ÇæÅB"))
#else
    ...
    if (beam.flavour == BEAM_BANISH)
    {
        ...
        {
#ifdef JP
            simple_monster_message(mon, "ÇÕàÍèuÇÃä‘ÇÆÇÁÇ¬Ç¢ÇΩÅB");
#else
...
#ifdef JP
        if (simple_monster_message(mon, "ÇÕåÉÇµÇ≠·zùπÇµÇΩÅI"))
#else
...
#ifdef JP
        simple_monster_message(mon, "ÇÕó∏Ç…Ç»Ç¡ÇΩÅB");
#else
...
#ifdef JP
        if (simple_monster_message(mon, "ÇÕãÍí…Ç…·zùπÇµÇΩÅI"))
#else
...
#ifdef JP
        if (strstr( beam.beam_name, "ãÍñ„" ) != NULL)
#else
    ...
    {
#ifdef JP
        if (simple_monster_message(mon, "ÇÕîöîjÇ≥ÇÍÇΩÅB"))
#else
...
#ifdef JP
        if (simple_monster_message(mon, "ÇÕÇ‹Ç«ÇÎÇÒÇ≈Ç¢ÇÈÅcÅcÅB"))
#else
...
#ifdef JP
    if (strcmp( beam.beam_name, "ínçñÇÃã∆âŒ" ) == 0)
#else
...
static void explosion1(struct bolt &pbolt)
{
...
#ifdef JP
    if (stricmp(pbolt.beam_name, "ínçñÇÃã∆âŒ") == 0)
#else
    if (stricmp(pbolt.beam_name, "hellfire") == 0)
#endif
    {
#ifdef JP
        seeMsg = "ínçñÇÃã∆âŒÇ™îöî≠ÇµÇΩÅI";
...
#ifdef JP
    if (stricmp(pbolt.beam_name, "â©ã‡ÇÃâä") == 0)
#else
    if (stricmp(pbolt.beam_name, "golden flame") == 0)
#endif
    {
#ifdef JP
        seeMsg = "âäÇ™îöî≠ÇµÇΩÅI";
        hearMsg = "Ç†Ç»ÇΩÇÕäÔñ≠Ç»îöî≠âπÇé®Ç…ÇµÇΩÅB";
#else
...
#ifdef JP
    if (stricmp(pbolt.beam_name, "ÉtÉ@ÉCÉAÉ{Å[Éã") == 0)
#else
    if (stricmp(pbolt.beam_name, "fireball") == 0)
#endif
    {
#ifdef JP
        seeMsg = "ÉtÉ@ÉCÉAÉ{Å[ÉãÇ™îöî≠ÇµÇΩÅI";
        hearMsg = "Ç†Ç»ÇΩÇÕîöî≠âπÇé®Ç…ÇµÇΩÅB";
#else
...
#ifdef JP
    if (stricmp(pbolt.beam_name, "ìdåÇÇÃîöóÙãÖ") == 0)
#else
    if (stricmp(pbolt.beam_name, "orb of electricity") == 0)
#endif
    {
#ifdef JP
        seeMsg = "ìdãCÇÃãÖëÃÇ™îöî≠ÇµÇΩÅI";
        hearMsg = "Ç†Ç»ÇΩÇÕóãñ¬Çé®Ç…ÇµÇΩÅI";
#else
...
#ifdef JP
    if (stricmp(pbolt.beam_name, "ÉGÉlÉãÉMÅ[ÇÃîöóÙãÖ") == 0)
#else
    if (stricmp(pbolt.beam_name, "orb of energy") == 0)
#endif
    {
#ifdef JP
        seeMsg = "ÉGÉlÉãÉMÅ[ÇÃãÖëÃÇ™îöî≠ÇµÇΩÅB";
        hearMsg = "Ç†Ç»ÇΩÇÕîöâπÇé®Ç…ÇµÇΩÅB";
#else
...
#ifdef JP
    if (stricmp(pbolt.beam_name, "ã‡ëÆï–ÇÃîöóÙãÖ") == 0)
#else
    if (stricmp(pbolt.beam_name, "metal orb") == 0)
#endif
    {
#ifdef JP
        seeMsg = "ãÖëÃÇ™îöî≠ÇµÅAívñΩìIÇ»éUíeÇ™éTÇ´éUÇÁÇ≥ÇÍÇΩÅI";
        hearMsg = "Ç†Ç»ÇΩÇÕîöâπÇé®Ç…ÇµÇΩÅB";
#else
...
#ifdef JP
        strcpy(pbolt.beam_name, "û÷éUíeÇÃâJ");
#else
...
#ifdef JP
    if (stricmp(pbolt.beam_name, "ìÄãCÇÃóí") == 0)
#else
    if (stricmp(pbolt.beam_name, "great blast of cold") == 0)
#endif
    {
#ifdef JP
        seeMsg = "ìÀïóÇ™îöî≠ÇµÇƒê¶Ç‹Ç∂Ç¢ïXÇÃóíÇ™ä™Ç´ãNÇ±Ç¡ÇΩÅI";
        hearMsg = "Ç†Ç»ÇΩÇÕåÉÇµÇ¢óíÇÃâπÇé®Ç…ÇµÇΩÅB";
#else
...
#ifdef JP
    if (stricmp(pbolt.beam_name, "·èãCÇÃîöóÙãÖ") == 0)
#else
    if (stricmp(pbolt.beam_name, "ball of vapour") == 0)
#endif
    {
#ifdef JP
        seeMsg = "ãÖëÃÇÕägéUÇµÇƒà´èLÇï˙Ç¬â_Ç…Ç»Ç¡ÇΩÅI";
        hearMsg = "Ç†Ç»ÇΩÇÕÇ‰ÇÈÇ‚Ç©Ç»ÅwÉvÉDÅ`ÅxÇ∆Ç¢Ç§âπÇé®Ç…ÇµÇΩÅB.";
        strcpy(pbolt.beam_name, "à´èLÇÃâ_");
#else
...
#ifdef JP
    if (stricmp(pbolt.beam_name, "É|Å[ÉVÉáÉì") == 0)
#else
    if (stricmp(pbolt.beam_name, "potion") == 0)
#endif
    {
#ifdef JP
        seeMsg = "É|Å[ÉVÉáÉìÇ™îöî≠Çä™Ç´ãNÇ±ÇµÇΩÅI";
        hearMsg = "Ç†Ç»ÇΩÇÕîöâπÇé®Ç…ÇµÇΩÅB";
        strcpy(pbolt.beam_name, "â_");
#else
    ...
    {
#ifdef JP
        seeMsg = "åıê¸Ç™îöóÙÇµÉ\ÉtÉgÉEÉFÉAÉoÉOÇÃâ_Ç™î≠ê∂ÇµÇΩÅI";
        hearMsg = "Ç†Ç»ÇΩÇÕîèéËÇÃâπÇé®Ç…ÇµÇΩÅI";
#else
