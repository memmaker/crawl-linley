...
#ifdef JP
{
    MONS_PROGRAM_BUG, 'B', LIGHTRED, "プログラムバグ",
    M_NO_EXP_GAIN,
...
{
    MONS_GIANT_ANT, 'a', DARKGREY, "巨大アリ",
    M_ED_POISON,
...
{
    MONS_GIANT_BAT, 'b', DARKGREY, "大コウモリ",
...
{
    MONS_FUNGUS, 'f', LIGHTGREY, "お化けキノコ",
...
{
    MONS_KILLER_BEE_LARVA, 'w', LIGHTGREY, "殺人蜂の幼虫",
...
{
    MONS_NECROPHAGE, 'n', DARKGREY, "屍肉喰らい",
...
{
    MONS_TUNNELING_WORM, 't', LIGHTRED, "トンネルワーム",
    M_RES_POISON,
...
{
    MONS_FIRE_VORTEX, 'v', RED, "ファイアボルテックス",
...
// random
{
    MONS_ABOMINATION_SMALL, 'x', BLACK, "忌まわしきもの",
    M_NO_FLAGS,
...
{
    MONS_GIANT_BEETLE, 'B', DARKGREY, "ジャイアントビートル",
    M_ED_POISON,
...
{
    MONS_TWO_HEADED_OGRE, 'O', LIGHTRED, "双頭のオーガ",
    M_WARM_BLOOD,
...
{
    MONS_FIEND, '1', LIGHTRED, "魔神", //jmf: was RED, like Balrog
...
{
    MONS_GUARDIAN_NAGA, 'N', LIGHTGREEN, "ナーガの衛兵",
...
{
    MONS_UNSEEN_HORROR, 'x', MAGENTA, "見えざる恐怖",
...
{
    MONS_ABOMINATION_LARGE, 'X', BLACK, "忌まわしきもの",
    M_NO_FLAGS,
...
{
    MONS_ORC_WARRIOR, 'o', YELLOW, "オークの戦士",
    M_WARM_BLOOD,
...
{
    MONS_KOBOLD_DEMONOLOGIST, 'K', MAGENTA, "コボルドの悪魔術師",
...
{
    MONS_ORC_WIZARD, 'o', MAGENTA, "オークの魔術師",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD,
...
{
    MONS_ORC_KNIGHT, 'o', LIGHTCYAN, "オークの騎士",
    M_WARM_BLOOD,
    0, 10, MONS_ORC, MH_NATURAL, -3,
    { 25, 0, 0, 0 },
    { 9, 4, 7, 0 },
...
{
    MONS_GIANT_EYEBALL, 'G', WHITE, "巨大眼球",
...
{
    MONS_OKLOB_PLANT, 'P', GREEN, "オクロブ草",
    M_RES_POISON,
...
{
    MONS_WOLF_SPIDER, 's', BROWN, "大喰い蜘蛛",
    M_ED_POISON,
...
{
    MONS_HUNGRY_GHOST, 'p', GREEN, "はらぺこゴースト",
...
{
    MONS_EYE_OF_DRAINING, 'G', LIGHTGREY, "掠奪の巨大眼球",
...
{
    MONS_WANDERING_MUSHROOM, 'f', BROWN, "這いずりキノコ",
    M_RES_POISON,
...
{
    MONS_BRAIN_WORM, 'w', LIGHTMAGENTA, "脳髄ワーム",
    M_SPELLCASTER,
...
{
    MONS_GIANT_ORANGE_BRAIN, 'G', LIGHTRED, "オレンジ色の巨大脳髄",
...
{
    MONS_BOULDER_BEETLE, 'B', LIGHTGREY, "岩石ビートル",
    M_ED_POISON,
...
{
    MONS_FLYING_SKULL, 'z', WHITE, "空飛ぶ頭蓋骨",
...
{
    MONS_HELL_HOUND, 'h', DARKGREY, "ヘルハウンド",
...
{
    MONS_MINOTAUR, 'm', LIGHTRED, "ミノタウロス",
    M_WARM_BLOOD,
...
{
    MONS_ICE_DRAGON, 'D', WHITE, "アイスドラゴン",
...
{
    MONS_SLIME_CREATURE, 'J', GREEN, "スライム",
...
{
    MONS_FREEZING_WRAITH, 'W', LIGHTBLUE, "凍気のレイス",
...
{
    MONS_RAKSHASA_FAKE, 'R', YELLOW, "ラクシャーサ",
    M_RES_POISON,
...
{
    MONS_GREAT_ORB_OF_EYES, 'G', LIGHTGREEN, "あまたの目の球体",
...
{
    MONS_ROTTING_DEVIL, '4', GREEN, "腐爛の悪魔",
    M_RES_POISON | M_RES_COLD,
...
{
    MONS_REAPER, '2', LIGHTGREY, "切り裂きの悪魔",
    M_RES_POISON | M_RES_COLD | M_SEE_INVIS,
...
{
    MONS_SOUL_EATER, '2', DARKGREY, "魂を貪るもの",
    M_RES_POISON | M_RES_COLD | M_LEVITATE | M_SEE_INVIS,
...
{
    MONS_HAIRY_DEVIL, '4', LIGHTRED, "毛むくじゃら悪魔",
    M_RES_POISON,
...
{
    MONS_GLOWING_SHAPESHIFTER, '@', RED, "暴走した変身能力者",
    M_NO_FLAGS,
...
{
    MONS_SHAPESHIFTER, '@', LIGHTRED, "変身能力者",
    M_NO_FLAGS,
    600, 10, MONS_SHAPESHIFTER, MH_NATURAL, -6,
    { 5, 0, 0, 0 },
    { 7, 3, 5, 0 },
...
{
    MONS_GIANT_MITE, 's', LIGHTRED, "巨大ダニ",
    M_ED_POISON,
...
{
    MONS_STEAM_DRAGON, 'd', LIGHTGREY, "蒸気ドラゴン",
...
{
    MONS_VERY_UGLY_THING, 'u', RED, "甚だしく醜きもの",
    M_WARM_BLOOD | M_AMPHIBIOUS,
...
{
    MONS_ORC_SORCERER, 'o', DARKGREY, "オークの魔道士",
...
{
    MONS_NECROMANCER, '@', DARKGREY, "死人使い",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD,
...
{
    MONS_ORC_PRIEST, 'o', LIGHTGREEN, "オークの司祭",
...
{
    MONS_ORC_HIGH_PRIEST, 'o', GREEN, "オークの大司祭",
...
{
    MONS_CLAY_GOLEM, '8', BROWN, "土のゴーレム",
...
{
    MONS_WOOD_GOLEM, '8', YELLOW, "木のゴーレム",
...
{
    MONS_STONE_GOLEM, '8', LIGHTGREY, "石のゴーレム",
...
{
    MONS_CRYSTAL_GOLEM, '8', WHITE, "水晶のゴーレム",
    M_RES_POISON | M_RES_FIRE | M_RES_COLD | M_RES_ELEC | M_SEE_INVIS,
...
{
    MONS_TOENAIL_GOLEM, '8', LIGHTGREY, "爪のゴーレム",
    M_RES_POISON | M_RES_FIRE | M_RES_COLD | M_RES_ELEC,
...
{
    MONS_MOTTLED_DRAGON, 'd', LIGHTMAGENTA, "斑紋ドラゴン",
...
{
    MONS_EARTH_ELEMENTAL, '#', BROWN, "大地の精霊",
    M_RES_POISON | M_RES_FIRE | M_RES_COLD | M_RES_ELEC,
...
{
    MONS_FIRE_ELEMENTAL, '#', YELLOW, "火の精霊",
...
{
    MONS_AIR_ELEMENTAL, 'v', LIGHTGREY, "大気の精霊",
...
{
    MONS_SHADOW_FIEND, '1', DARKGREY, "影の魔神",
...
{
    MONS_GIANT_LIZARD, 'l', GREEN, "大トカゲ",
    M_COLD_BLOOD,
...
{
    MONS_SPECTRAL_WARRIOR, 'W', LIGHTGREEN, "亡霊の戦士",
    M_RES_POISON | M_RES_COLD | M_LEVITATE | M_SEE_INVIS,
...
{
    MONS_PULSATING_LUMP, 'J', RED, "悶える肉塊",
...
{
    MONS_STORM_DRAGON, 'D', LIGHTBLUE, "ストームドラゴン",
...
{
    MONS_DEATH_YAK, 'Y', DARKGREY, "人食いヤク",
    M_WARM_BLOOD,
...
{
    MONS_ROCK_TROLL, 'T', LIGHTGREY, "岩トロル",
    M_WARM_BLOOD,
...
{
    MONS_STONE_GIANT, 'C', LIGHTGREY, "ストーンジャイアント",
    M_WARM_BLOOD,
...
{
    MONS_REDBACK, 's', RED, "背赤蜘蛛",  //セアカゴケグモ
    M_ED_POISON,
...
{
    MONS_INSUBSTANTIAL_WISP, 'p', LIGHTGREY, "稀薄な霧",
...
{
    MONS_OGRE_MAGE, 'O', MAGENTA, "オーガメイジ",
...
{
    MONS_SPINY_WORM, 'w', DARKGREY, "スパイクワーム",
    M_ED_POISON,
...
//  to examine them.
{
    MONS_DANCING_WEAPON, '(', BLACK, "宙を舞う武器",
...
{
    MONS_GOLDEN_DRAGON, 'D', YELLOW, "ゴールドドラゴン",
...
{
    MONS_LINDWURM, 'd', LIGHTGREEN, "リンドヴルム",
    M_NO_FLAGS,
...
{
    MONS_ELEPHANT_SLUG, 'm', LIGHTGREY, "象ナメクジ",
    M_ED_POISON | M_NO_SKELETON,
...
{
    MONS_GREY_RAT, 'r', LIGHTGREY, "灰色ネズミ",
    M_WARM_BLOOD,
...
{
    MONS_GREEN_RAT, 'r', LIGHTGREEN, "緑色ネズミ",
    M_WARM_BLOOD,
...
{
    MONS_ORANGE_RAT, 'r', LIGHTRED, "オレンジネズミ",
    M_WARM_BLOOD,
...
{
    MONS_BLACK_SNAKE, 'S', DARKGREY, "黒蛇",
...
{
    MONS_GIANT_MOSQUITO, 'y', DARKGREY, "巨大な蚊",
    M_ED_POISON | M_FLIES,
...
{
    MONS_GIANT_CENTIPEDE, 's', GREEN, "巨大ムカデ",
    M_ED_POISON,
...
{
    MONS_FIRE_GIANT, 'C', RED, "ファイアジャイアント",
...
{
    MONS_FROST_GIANT, 'C', LIGHTBLUE, "フロストジャイアント",
...
{
    MONS_SHADOW_DRAGON, 'D', DARKGREY, "シャドウドラゴン",
...
,
{
    MONS_YELLOW_SNAKE, 'S', YELLOW, "黄色蛇",
    M_RES_POISON | M_COLD_BLOOD,
...
{
    MONS_GREY_SNAKE, 'S', LIGHTGREY, "灰色蛇",
    M_COLD_BLOOD,
...
{
    MONS_DEEP_TROLL, 'T', DARKGREY, "洞窟トロル",
...
{
    MONS_GIANT_BLOWFLY, 'y', LIGHTGREY, "巨大アオバエ",
    M_ED_POISON | M_FLIES,
...
{
    MONS_SWAMP_DRAGON, 'D', BROWN, "沼ドラゴン",
...
{
    MONS_SWAMP_DRAKE, 'd', BROWN, "沼ドレイク",
    M_SPELLCASTER | M_FLIES | M_RES_POISON,
...
{
    MONS_SOLDIER_ANT, 'a', LIGHTGREY, "兵隊アリ",
    M_ED_POISON,
...
{
    MONS_HILL_GIANT, 'C', LIGHTRED, "丘ジャイアント",
    M_WARM_BLOOD,
...
{
    MONS_QUEEN_ANT, 'Q', DARKGREY, "女王アリ",
    M_ED_POISON,
...
{
    MONS_ANT_LARVA, 'w', LIGHTGREY, "アリの幼虫",
    M_ED_POISON | M_NO_SKELETON,
...
{
    MONS_GIANT_BROWN_FROG, 'F', BROWN, "茶色大ガエル",
    M_COLD_BLOOD | M_AMPHIBIOUS,
...
{
    MONS_BLINK_FROG, 'F', LIGHTGREEN, "またたきガエル",
    M_COLD_BLOOD | M_AMPHIBIOUS,
...
,
{
    MONS_GIANT_COCKROACH, 'a', BROWN, "巨大ゴキブリ",
    M_NO_FLAGS,
...
,
{
    MONS_SMALL_SNAKE, 'S', LIGHTGREEN, "小蛇",
    M_COLD_BLOOD,
...
{
    MONS_UFETUBUS, '5', LIGHTCYAN, "ウフェツバス",
...
{
    MONS_ORANGE_DEMON, '3', LIGHTRED, "オレンジデーモン",
    M_NO_FLAGS,
...
{
    MONS_HELLWING, '3', LIGHTGREY, "ヘルウィング",
...
{
    MONS_SMOKE_DEMON, '4', LIGHTGREY, "噴煙のデーモン",
    M_RES_POISON | M_RES_FIRE | M_SPELLCASTER | M_FLIES,
...
{
    MONS_EXECUTIONER, '1', LIGHTGREY, "処刑の悪魔",
...
{
    MONS_GREEN_DEATH, '1', GREEN, "緑の殲滅者",
    M_RES_POISON | M_SPELLCASTER | M_SEE_INVIS,
...
{
    MONS_DEMONIC_CRAWLER, '3', DARKGREY, "ムカデの悪魔",
...
{
    MONS_SUN_DEMON, '2', YELLOW, "サンデーモン",
...
{
    MONS_SHADOW_IMP, '5', DARKGREY, "影のインプ",
...
{
    MONS_SHADOW_DEMON, '3', DARKGREY, "シャドウデーモン",
...
{
    MONS_LOROCYPROCA, '2', BLUE, "ロロキプロカ",
...
{
    MONS_SHADOW_WRAITH, 'W', BLUE, "シャドウレイス",
...
{
    MONS_GIANT_AMOEBA, 'J', BLUE, "巨大アメーバ",
...
{
    MONS_GIANT_SLUG, 'm', GREEN, "巨大ナメクジ",
...
{
    MONS_GIANT_SNAIL, 'm', LIGHTGREEN, "巨大カタツムリ",
    M_NO_SKELETON | M_AMPHIBIOUS,
...
{
    MONS_SPATIAL_VORTEX, 'v', BLACK, "時空ボルテックス",
...
{
    MONS_BORING_BEETLE, 'B', BROWN, "削岩ビートル",
    M_ED_POISON,
...
{
    MONS_GARGOYLE, 'g', DARKGREY, "ガーゴイル",
...
{
    MONS_METAL_GARGOYLE, 'g', CYAN, "金属ガーゴイル",
    M_RES_POISON | M_RES_ELEC | M_FLIES,
...
{
    MONS_MOLTEN_GARGOYLE, 'g', RED, "溶岩ガーゴイル",
...
{
    MONS_LOM_LOBON, '&', LIGHTBLUE, "ロム・ロボン",
...
{
    MONS_GLOORX_VLOQ, '&', DARKGREY, "グロオルクス・ヴロック",
...
{
    MONS_NAGA_MAGE, 'N', LIGHTRED, "ナーガの魔術師",
...
{
    MONS_NAGA_WARRIOR, 'N', BLUE, "ナーガの戦士",
    M_RES_POISON | M_SPELLCASTER | M_ACTUAL_SPELLS | M_SEE_INVIS | M_WARM_BLOOD,
...
{
    MONS_ORC_WARLORD, 'o', LIGHTGREY, "オークの族長",
    M_WARM_BLOOD,
...
{
    MONS_DEEP_ELF_SOLDIER, 'e', CYAN, "闇エルフの兵士",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD,
...
{
    MONS_DEEP_ELF_FIGHTER, 'e', LIGHTBLUE, "闇エルフの戦士",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD,
    450, 10, MONS_ELF, MH_NATURAL, -6,
    { 9, 0, 0, 0 },
    { 6, 3, 3, 0 },
...
{
    MONS_DEEP_ELF_KNIGHT, 'e', BLUE, "闇エルフの騎士",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD,
    450, 10, MONS_ELF, MH_NATURAL, -6,
    { 14, 0, 0, 0 },
    { 11, 3, 3, 0 },
...
{
    MONS_DEEP_ELF_MAGE, 'e', LIGHTRED, "闇エルフの魔術師",
...
{
    MONS_DEEP_ELF_SUMMONER, 'e', YELLOW, "闇エルフの召換術師",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD,
    450, 10, MONS_ELF, MH_NATURAL, -6,
    { 5, 0, 0, 0 },
    { 6, 3, 3, 0 },
...
{
    MONS_DEEP_ELF_CONJURER, 'e', LIGHTGREEN, "闇エルフの妖術師",
...
{
    MONS_DEEP_ELF_PRIEST, 'e', LIGHTGREY, "闇エルフの司祭",
    M_SPELLCASTER | M_PRIEST | M_WARM_BLOOD,
    450, 10, MONS_ELF, MH_NATURAL, -6,
    { 9, 0, 0, 0 },
    { 5, 3, 3, 0 },
...
{
    MONS_DEEP_ELF_HIGH_PRIEST, 'e', DARKGREY, "闇エルフの大司祭",
...
{
    MONS_DEEP_ELF_DEMONOLOGIST, 'e', MAGENTA, "闇エルフの悪魔術師",
...
{
    MONS_DEEP_ELF_ANNIHILATOR, 'e', GREEN, "闇エルフの破壊者",
...
{
    MONS_DEEP_ELF_SORCERER, 'e', RED, "闇エルフの魔道士",
...
{
    MONS_DEEP_ELF_DEATH_MAGE, 'e', WHITE, "闇エルフの死の魔術師",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD | M_SEE_INVIS,
    450, 10, MONS_ELF, MH_NATURAL, -6,
    { 12, 0, 0, 0 },
    { 15, 3, 3, 0 },
...
{
    MONS_BROWN_OOZE, 'J', BROWN, "ブラウンウーズ",
...
{
    MONS_AZURE_JELLY, 'J', LIGHTBLUE, "紺碧ジェリー",
...
{
    MONS_DEATH_OOZE, 'J', DARKGREY, "デスウーズ",
...
{
    MONS_ACID_BLOB, 'J', LIGHTGREEN, "酸のブロブ",
    M_RES_POISON | M_NO_SKELETON | M_SEE_INVIS,
...
{
    MONS_ROYAL_JELLY, 'J', YELLOW, "ロイヤルジェリー",
    M_RES_POISON | M_NO_SKELETON | M_SEE_INVIS,
...
{
    MONS_BLORK_THE_ORC, 'o', BROWN, "オークの『ブロルク』",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_SPEAKS | M_WARM_BLOOD,
...

{
    ...
    MONUSE_WEAPONS_ARMOUR
}//フランセスとすることでFRANCESと区別
,

{
    MONS_FRANCES, '@', YELLOW, "『フランセス』",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_SPEAKS | M_WARM_BLOOD | M_SEE_INVIS,
    0, 20, MONS_HUMAN, MH_NATURAL, -5,
    { 11, 0, 0, 0 },
    { 14, 0, 0, 70 },
...
{
    MONS_ASMODEUS, '&', LIGHTMAGENTA, "『アスモデウス』",
...
{
    MONS_ANTAEUS, 'C', LIGHTCYAN, "『アンテウス』",
...
{
    MONS_ANCIENT_LICH, 'L', DARKGREY, "太古のリッチ",
...
/* These nasties are never randomly generated, only sometimes specially
   placed in the Crypt. */
{
    MONS_CURSE_SKULL, 'z', DARKGREY, "呪いの頭蓋骨",
...
{
    MONS_VAMPIRE_KNIGHT, 'V', CYAN, "ヴァンパイアの騎士",
    M_RES_POISON | M_RES_COLD | M_SPELLCASTER | M_SEE_INVIS,
...
{
    MONS_VAMPIRE_MAGE, 'V', MAGENTA, "ヴァンパイアメイジ",
...
{
    MONS_SHINING_EYE, 'G', LIGHTMAGENTA, "輝く眼球",
...
{
    MONS_ORB_GUARDIAN, 'X', MAGENTA, "オーブの守護者",
...
{
    MONS_GREATER_NAGA, 'N', RED, "ナーガの猛者",
    M_RES_POISON | M_SPELLCASTER | M_ACTUAL_SPELLS | M_SEE_INVIS | M_WARM_BLOOD,
...
{
    MONS_SKELETAL_DRAGON, 'D', LIGHTGREY, "骸骨ドラゴン",
    M_RES_POISON | M_RES_FIRE | M_RES_COLD | M_RES_ELEC | M_SEE_INVIS,
...
{
    MONS_TENTACLED_MONSTROSITY, 'X', GREEN, "触手の怪物",
...
{
    MONS_SPHINX, 'H', LIGHTGREY, "スフィンクス",
...
{
    MONS_ROTTING_HULK, 'n', BROWN, "腐肉の巨漢",
    M_RES_POISON | M_RES_COLD,
...
{
    MONS_GUARDIAN_MUMMY, 'M', YELLOW, "衛兵のミイラ",
    M_RES_POISON | M_RES_COLD | M_SEE_INVIS,
...
{
    MONS_GREATER_MUMMY, 'M', DARKGREY, "王族のミイラ",
    M_RES_POISON | M_RES_COLD | M_RES_ELEC | M_SPELLCASTER | M_ACTUAL_SPELLS | M_SEE_INVIS,
...
{
    MONS_MUMMY_PRIEST, 'M', RED, "司祭のミイラ",
...
{
    MONS_CENTAUR_WARRIOR, 'c', YELLOW, "セントールの戦士",
    M_WARM_BLOOD,
...
{
    MONS_YAKTAUR_CAPTAIN, 'c', RED, "ヤクトールの族長",
    M_WARM_BLOOD,
    2000, 10, MONS_YAKTAUR, MH_NATURAL, -3,
    { 23, 0, 0, 0 },
    { 14, 3, 5, 0 },
...
{
    MONS_ELECTRIC_GOLEM, '8', LIGHTCYAN, "電気のゴーレム",
...
{
    MONS_BALL_LIGHTNING, '*', LIGHTCYAN, "球雷",
...
{
    MONS_EYE_OF_DEVASTATION, 'G', YELLOW, "破滅の眼球",
    M_NO_SKELETON | M_LEVITATE | M_SPELLCASTER | M_SEE_INVIS,
...
{
    MONS_MOTH_OF_WRATH, 'y', BROWN, "忿怒せる蛾",
    M_FLIES,
...
{
    MONS_DEATH_COB, '%', YELLOW, "殺人トウモロコシ",
...
{
    MONS_CURSE_TOE, 'z', DARKGREY, "呪いの足指", 
    M_RES_ELEC | M_RES_POISON | M_RES_HELLFIRE | M_RES_COLD | M_LEVITATE | M_SPELLCASTER | M_SEE_INVIS,
...
{
    MONS_SCROLL_MIMIC, '?', LIGHTGREY, "ミミック",
    M_NO_SKELETON | M_RES_POISON | M_RES_ELEC | M_RES_FIRE | M_RES_COLD,
    0, 13, MONS_GOLD_MIMIC, MH_NONLIVING, -3,
    { 12, 12, 12, 0 },
    { 8, 3, 5, 0 },
...
{
    MONS_SERPENT_OF_HELL, 'D', RED, "地獄のサーペント",
...
{
    MONS_QUICKSILVER_DRAGON, 'D', LIGHTCYAN, "水銀ドラゴン",
...
{
    MONS_SKELETAL_WARRIOR, 'z', CYAN, "骸骨戦士",
...
{  // mv: was another lava thing
    MONS_SALAMANDER, 'S', LIGHTRED, "サラマンダー",
...
{
    MONS_GIANT_GOLDFISH, ';', LIGHTRED, "巨大金魚",
    M_COLD_BLOOD,
...
{
    MONS_ELECTRICAL_EEL, ';', LIGHTBLUE, "電気ウナギ",
...
{
    MONS_WATER_ELEMENTAL, '{', LIGHTBLUE, "水の精霊",
...
#if 0 
{
    MONS_SHUGGOTH, 'A', LIGHTGREEN, "ショゴス",
...
{
    MONS_GRIZZLY_BEAR, 'U', LIGHTGREY, "灰色熊",
    M_WARM_BLOOD,
...
{
    MONS_GIANT_NEWT, 'l', LIGHTGREEN, "巨大イモリ",
    M_COLD_BLOOD | M_AMPHIBIOUS,
...
{
    MONS_GIANT_GECKO, 'l', YELLOW, "巨大ヤモリ",
    M_COLD_BLOOD,
...
{
    MONS_GIANT_IGUANA, 'l', BLUE, "巨大イグアナ",
    M_COLD_BLOOD,
...

{
    ...
    MONS_GILA_MONSTER, 'l', BLACK, "ドクトカゲ",
    M_COLD_BLOOD,
...
{
    MONS_KOMODO_DRAGON, 'l', BROWN, "コモドドラゴン",
    M_COLD_BLOOD | M_AMPHIBIOUS,
