...
#ifdef JP
            sprintf(buf, "%d枚の金貨", item.quantity);
#else
...
#ifdef JP
    mpr(en? "この地点に配置されたアイテムを記録します。"
        : "この地点に配置されたアイテムを無視します。");
#else
